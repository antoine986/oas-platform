...
const SCHEMAS = {
  1: `<svg width="100%" viewBox="0 0 540 180" role="img"><title>Architecture globale machine outbound</title><defs><marker id="ar" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M2 1L8 5L2 9" fill="none" stroke="context-stroke" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></marker></defs><rect x="200" y="60" width="140" height="56" rx="9" fill="#E0F5EE" stroke="#0F6E56" stroke-width="1.5"/><text x="270" y="83" text-anchor="middle" font-size="12" font-weight="700" fill="#085041">Clay</text><text x="270" y="100" text-anchor="middle" font-size="10" fill="#0F6E56">Moteur d'orchestration</text><rect x="14" y="20" width="110" height="34" rx="7" fill="#EFF6FF" stroke="#185FA5" stroke-width="1"/><text x="69" y="41" text-anchor="middle" font-size="10" fill="#042C53">Sales Nav / Apollo</text><rect x="14" y="68" width="110" height="34" rx="7" fill="#EFF6FF" stroke="#185FA5" stroke-width="1"/><text x="69" y="89" text-anchor="middle" font-size="10" fill="#185FA5">CSV importé</text><rect x="14" y="116" width="110" height="34" rx="7" fill="#EFF6FF" stroke="#185FA5" stroke-width="1"/><text x="69" y="137" text-anchor="middle" font-size="10" fill="#185FA5">HubSpot / Blocklist</text><line x1="124" y1="37" x2="200" y2="80" stroke="#185FA5" stroke-width="1" marker-end="url(#ar)"/><line x1="124" y1="85" x2="200" y2="90" stroke="#185FA5" stroke-width="1" marker-end="url(#ar)"/><line x1="124" y1="133" x2="200" y2="100" stroke="#185FA5" stroke-width="1" marker-end="url(#ar)"/><rect x="416" y="20" width="110" height="34" rx="7" fill="#ECFDF5" stroke="#059669" stroke-width="1"/><text x="471" y="41" text-anchor="middle" font-size="10" fill="#064E3B">Heyreach / Lemlist</text><rect x="416" y="68" width="110" height="34" rx="7" fill="#ECFDF5" stroke="#059669" stroke-width="1"/><text x="471" y="89" text-anchor="middle" font-size="10" fill="#059669">HubSpot enrichi</text><rect x="416" y="116" width="110" height="34" rx="7" fill="#FEF3C7" stroke="#D97706" stroke-width="1"/><text x="471" y="137" text-anchor="middle" font-size="10" fill="#92400E">Icebreakers IA</text><line x1="340" y1="80" x2="416" y2="37" stroke="#0F6E56" stroke-width="1" marker-end="url(#ar)"/><line x1="340" y1="90" x2="416" y2="85" stroke="#0F6E56" stroke-width="1" marker-end="url(#ar)"/><line x1="340" y1="100" x2="416" y2="133" stroke="#0F6E56" stroke-width="1" marker-end="url(#ar)"/><rect x="150" y="148" width="240" height="24" rx="6" fill="#FEF2F2" stroke="#FCA5A5" stroke-width="0.5"/><text x="270" y="164" text-anchor="middle" font-size="10" fill="#991B1B">Aucune action sans condition Run if</text></svg>`,
  2: `<svg width="100%" viewBox="0 0 540 180" role="img"><title>ICP segmentation signaux exploitables</title><defs><marker id="ar2" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M2 1L8 5L2 9" fill="none" stroke="context-stroke" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></marker></defs><rect x="20" y="10" width="500" height="42" rx="8" fill="#EFF6FF" stroke="#185FA5" stroke-width="1"/><text x="270" y="27" text-anchor="middle" font-size="11" font-weight="700" fill="#042C53">Niveau 1 — Firmographique</text><text x="270" y="43" text-anchor="middle" font-size="10" fill="#185FA5">Taille · Secteur · Pays · Revenus</text><line x1="270" y1="52" x2="270" y2="65" stroke="#9CA3AF" stroke-width="1" marker-end="url(#ar2)"/><rect x="50" y="65" width="440" height="42" rx="8" fill="#F5F3FF" stroke="#7C3AED" stroke-width="1"/><text x="270" y="82" text-anchor="middle" font-size="11" font-weight="700" fill="#3730A3">Niveau 2 — Comportemental</text><text x="270" y="98" text-anchor="middle" font-size="10" fill="#7C3AED">Stack technologique · Type de business · Canaux utilisés</text><line x1="270" y1="107" x2="270" y2="120" stroke="#9CA3AF" stroke-width="1" marker-end="url(#ar2)"/><rect x="80" y="120" width="380" height="42" rx="8" fill="#E0F5EE" stroke="#0F6E56" stroke-width="1.5"/><text x="270" y="137" text-anchor="middle" font-size="11" font-weight="700" fill="#085041">Niveau 3 — Signal de croissance ★</text><text x="270" y="153" text-anchor="middle" font-size="10" fill="#0F6E56">Recrutement · Levée de fonds · Expansion · Nouveau décideur</text><rect x="165" y="167" width="210" height="16" rx="4" fill="#FEF3C7" stroke="#D97706" stroke-width="0.5"/><text x="270" y="179" text-anchor="middle" font-size="9" fill="#92400E">Le niveau 3 fait la différence — c'est lui qui génère des réponses</text></svg>`,
  3: `<svg width="100%" viewBox="0 0 540 200" role="img"><title>Architecture tables Clay TAM Blocklist Approved</title><defs><marker id="ar3" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M2 1L8 5L2 9" fill="none" stroke="context-stroke" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></marker></defs><rect x="8" y="8" width="155" height="80" rx="9" fill="#F9FAFB" stroke="#D1D5DB" stroke-width="1" stroke-dasharray="4 3"/><text x="85" y="24" text-anchor="middle" font-size="9" fill="#6B7280">Workbook séparé</text><rect x="15" y="30" width="62" height="50" rx="6" fill="#E0F5EE" stroke="#0F6E56" stroke-width="1"/><text x="46" y="50" text-anchor="middle" font-size="10" font-weight="700" fill="#085041">TAM</text><text x="46" y="65" text-anchor="middle" font-size="9" fill="#0F6E56">déjà</text><text x="46" y="77" text-anchor="middle" font-size="9" fill="#0F6E56">travaillées</text><rect x="83" y="30" width="72" height="50" rx="6" fill="#FEF2F2" stroke="#E24B4A" stroke-width="1"/><text x="119" y="50" text-anchor="middle" font-size="10" font-weight="700" fill="#991B1B">Blocklist</text><text x="119" y="65" text-anchor="middle" font-size="9" fill="#DC2626">clients</text><text x="119" y="77" text-anchor="middle" font-size="9" fill="#DC2626">existants</text><rect x="192" y="8" width="155" height="80" rx="9" fill="#EFF6FF" stroke="#185FA5" stroke-width="1"/><text x="269" y="28" text-anchor="middle" font-size="10" font-weight="700" fill="#042C53">Workbook Sourcing</text><text x="269" y="44" text-anchor="middle" font-size="9" fill="#185FA5">Find Companies ou CSV</text><text x="269" y="58" text-anchor="middle" font-size="9" fill="#185FA5">Normalize Domain</text><text x="269" y="72" text-anchor="middle" font-size="9" fill="#185FA5">Lookup TAM + Blocklist</text><text x="269" y="84" text-anchor="middle" font-size="9" fill="#0F6E56">Good Fit = "Approved"</text><line x1="163" y1="48" x2="192" y2="48" stroke="#6B7280" stroke-width="1" marker-end="url(#ar3)"/><rect x="376" y="8" width="156" height="80" rx="9" fill="#FFFBEB" stroke="#D97706" stroke-width="1.5"/><text x="454" y="26" text-anchor="middle" font-size="10" font-weight="700" fill="#92400E">Approved Companies</text><text x="454" y="42" text-anchor="middle" font-size="9" fill="#B45309">Run if Good Fit = Approved</text><text x="454" y="56" text-anchor="middle" font-size="9" fill="#B45309">Find People</text><text x="454" y="70" text-anchor="middle" font-size="9" fill="#B45309">Enrichissement email</text><text x="454" y="84" text-anchor="middle" font-size="9" fill="#B45309">Agents IA</text><line x1="347" y1="48" x2="376" y2="48" stroke="#D97706" stroke-width="1.5" marker-end="url(#ar3)"/><rect x="192" y="130" width="155" height="44" rx="9" fill="#ECFDF5" stroke="#059669" stroke-width="1"/><text x="269" y="150" text-anchor="middle" font-size="10" font-weight="700" fill="#064E3B">Outreach</text><text x="269" y="165" text-anchor="middle" font-size="9" fill="#059669">Heyreach · Lemlist · Smartlead</text><line x1="454" y1="88" x2="454" y2="112" stroke="#D97706" stroke-width="1" stroke-dasharray="3 2"/><line x1="454" y1="112" x2="308" y2="130" stroke="#059669" stroke-width="1.5" marker-end="url(#ar3)"/><rect x="55" y="184" width="430" height="16" rx="5" fill="#FEF2F2" stroke="#FCA5A5" stroke-width="0.5"/><text x="270" y="196" text-anchor="middle" font-size="9" fill="#991B1B">Ne jamais enrichir depuis la TAM/Blocklist — toujours depuis Approved Companies</text></svg>`,
  4: `<svg width="100%" viewBox="0 0 540 175" role="img"><title>Sourcing enrichissement waterfall Find People</title><defs><marker id="ar4" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M2 1L8 5L2 9" fill="none" stroke="context-stroke" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></marker></defs><rect x="5" y="10" width="96" height="80" rx="8" fill="#EFF6FF" stroke="#185FA5" stroke-width="1"/><text x="53" y="32" text-anchor="middle" font-size="11" font-weight="700" fill="#042C53">Sourcing</text><text x="53" y="50" text-anchor="middle" font-size="9" fill="#185FA5">Clay / Apollo</text><text x="53" y="64" text-anchor="middle" font-size="9" fill="#185FA5">Sales Nav CSV</text><line x1="101" y1="50" x2="116" y2="50" stroke="#9CA3AF" stroke-width="1" marker-end="url(#ar4)"/><rect x="116" y="10" width="96" height="80" rx="8" fill="#E0F5EE" stroke="#0F6E56" stroke-width="1"/><text x="164" y="32" text-anchor="middle" font-size="11" font-weight="700" fill="#085041">Qualify</text><text x="164" y="50" text-anchor="middle" font-size="9" fill="#0F6E56">TAM + Blocklist</text><text x="164" y="64" text-anchor="middle" font-size="9" fill="#0F6E56">Good Fit</text><line x1="212" y1="50" x2="227" y2="50" stroke="#9CA3AF" stroke-width="1" marker-end="url(#ar4)"/><rect x="227" y="10" width="96" height="80" rx="8" fill="#F5F3FF" stroke="#7C3AED" stroke-width="1"/><text x="275" y="32" text-anchor="middle" font-size="11" font-weight="700" fill="#3730A3">Find People</text><text x="275" y="50" text-anchor="middle" font-size="9" fill="#7C3AED">5 max / entrep.</text><text x="275" y="64" text-anchor="middle" font-size="9" fill="#7C3AED">Run if Approved</text><line x1="323" y1="50" x2="338" y2="50" stroke="#9CA3AF" stroke-width="1" marker-end="url(#ar4)"/><rect x="338" y="10" width="96" height="80" rx="8" fill="#FEF3C7" stroke="#D97706" stroke-width="1.5"/><text x="386" y="30" text-anchor="middle" font-size="11" font-weight="700" fill="#92400E">Email cascade</text><text x="386" y="47" text-anchor="middle" font-size="9" fill="#B45309">Full Enrich</text><text x="386" y="60" text-anchor="middle" font-size="9" fill="#B45309">Dropcontact</text><text x="386" y="73" text-anchor="middle" font-size="9" fill="#B45309">Enrichley valid.</text><line x1="434" y1="50" x2="449" y2="50" stroke="#9CA3AF" stroke-width="1" marker-end="url(#ar4)"/><rect x="449" y="10" width="86" height="80" rx="8" fill="#ECFDF5" stroke="#059669" stroke-width="1"/><text x="492" y="32" text-anchor="middle" font-size="11" font-weight="700" fill="#064E3B">Output</text><text x="492" y="50" text-anchor="middle" font-size="9" fill="#059669">Outreach</text><text x="492" y="64" text-anchor="middle" font-size="9" fill="#059669">prêt à lancer</text><rect x="5" y="102" width="530" height="22" rx="6" fill="#F9FAFB" stroke="#E5E7EB" stroke-width="0.5"/><text x="270" y="117" text-anchor="middle" font-size="10" fill="#374151">Chaque colonne a un Run if — enrichir sans condition = crédits perdus</text><rect x="338" y="133" width="197" height="40" rx="7" fill="#FFFBEB" stroke="#D97706" stroke-width="0.5"/><text x="436" y="150" text-anchor="middle" font-size="10" font-weight="600" fill="#92400E">Waterfall email</text><text x="436" y="166" text-anchor="middle" font-size="9" fill="#B45309">Full Enrich → trouvé ? stop. Sinon Dropcontact → Enrichley</text></svg>`,
  5: `<svg width="100%" viewBox="0 0 540 190" role="img"><title>Copy outbound icebreaker séquences multicanales</title><defs><marker id="ar5" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M2 1L8 5L2 9" fill="none" stroke="context-stroke" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></marker></defs><rect x="8" y="14" width="130" height="72" rx="8" fill="#FEF3C7" stroke="#D97706" stroke-width="1"/><text x="73" y="34" text-anchor="middle" font-size="11" font-weight="700" fill="#92400E">Signal</text><text x="73" y="52" text-anchor="middle" font-size="9" fill="#B45309">Recrutement</text><text x="73" y="65" text-anchor="middle" font-size="9" fill="#B45309">Levée de fonds</text><text x="73" y="78" text-anchor="middle" font-size="9" fill="#B45309">Expansion · nouveau poste</text><line x1="138" y1="50" x2="162" y2="50" stroke="#9CA3AF" stroke-width="1" marker-end="url(#ar5)"/><rect x="162" y="6" width="200" height="102" rx="8" fill="#E0F5EE" stroke="#0F6E56" stroke-width="1.5"/><text x="262" y="26" text-anchor="middle" font-size="11" font-weight="700" fill="#085041">Structure du message</text><rect x="172" y="34" width="180" height="20" rx="4" fill="#0F6E56"/><text x="262" y="48" text-anchor="middle" font-size="10" font-weight="600" fill="white">1. Observation</text><rect x="172" y="59" width="180" height="20" rx="4" fill="#1D9E75"/><text x="262" y="73" text-anchor="middle" font-size="10" font-weight="600" fill="white">2. Supposition prudente</text><rect x="172" y="84" width="180" height="20" rx="4" fill="#5DCAA5"/><text x="262" y="98" text-anchor="middle" font-size="10" font-weight="600" fill="#085041">3. Question ouverte</text><line x1="362" y1="50" x2="390" y2="50" stroke="#9CA3AF" stroke-width="1" marker-end="url(#ar5)"/><rect x="390" y="6" width="145" height="46" rx="7" fill="#EFF6FF" stroke="#185FA5" stroke-width="1"/><text x="462" y="24" text-anchor="middle" font-size="10" font-weight="600" fill="#042C53">LinkedIn</text><text x="462" y="40" text-anchor="middle" font-size="9" fill="#185FA5">Connexion sans message · J0</text><rect x="390" y="62" width="145" height="46" rx="7" fill="#F5F3FF" stroke="#7C3AED" stroke-width="1"/><text x="462" y="80" text-anchor="middle" font-size="10" font-weight="600" fill="#3730A3">Email</text><text x="462" y="96" text-anchor="middle" font-size="9" fill="#7C3AED">J0 · J3 · J7 · J14</text><rect x="8" y="117" width="524" height="30" rx="7" fill="#F9FAFB" stroke="#E5E7EB" stroke-width="0.5"/><text x="270" y="131" text-anchor="middle" font-size="10" fill="#374151">Sans signal : icebreaker basé sur un enjeu sectoriel universel lié au poste</text><text x="270" y="144" text-anchor="middle" font-size="9" fill="#6B7280">Jamais de chiffres inventés · jamais de flatterie · jamais de vente directe</text><rect x="162" y="156" width="200" height="30" rx="7" fill="#FEF3C7" stroke="#D97706" stroke-width="1"/><text x="262" y="172" text-anchor="middle" font-size="10" font-weight="600" fill="#92400E">Agent IA Clay</text><text x="262" y="183" text-anchor="middle" font-size="9" fill="#B45309">Run if Approved · test 5-10 lignes d'abord</text></svg>`,
  6: `<svg width="100%" viewBox="0 0 540 190" role="img"><title>Déploiement validation Is Outreach Ready</title><defs><marker id="ar6" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M2 1L8 5L2 9" fill="none" stroke="context-stroke" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></marker></defs><circle cx="48" cy="52" r="24" fill="#F9FAFB" stroke="#D1D5DB" stroke-width="1"/><text x="48" y="48" text-anchor="middle" font-size="13" font-weight="700" fill="#374151">1</text><text x="48" y="62" text-anchor="middle" font-size="8" fill="#6B7280">✓</text><text x="48" y="90" text-anchor="middle" font-size="9" font-weight="600" fill="#111827">Construire</text><text x="48" y="103" text-anchor="middle" font-size="8" fill="#6B7280">Run if partout</text><line x1="72" y1="52" x2="96" y2="52" stroke="#D1D5DB" stroke-width="1.5" marker-end="url(#ar6)"/><circle cx="120" cy="52" r="24" fill="#F9FAFB" stroke="#D1D5DB" stroke-width="1"/><text x="120" y="48" text-anchor="middle" font-size="13" font-weight="700" fill="#374151">2</text><text x="120" y="62" text-anchor="middle" font-size="8" fill="#6B7280">✓</text><text x="120" y="90" text-anchor="middle" font-size="9" font-weight="600" fill="#111827">Tester 5-10</text><text x="120" y="103" text-anchor="middle" font-size="8" fill="#6B7280">Ligne par ligne</text><line x1="144" y1="52" x2="168" y2="52" stroke="#D1D5DB" stroke-width="1.5" marker-end="url(#ar6)"/><circle cx="192" cy="52" r="24" fill="#F9FAFB" stroke="#D1D5DB" stroke-width="1"/><text x="192" y="48" text-anchor="middle" font-size="13" font-weight="700" fill="#374151">3</text><text x="192" y="62" text-anchor="middle" font-size="8" fill="#6B7280">✓</text><text x="192" y="90" text-anchor="middle" font-size="9" font-weight="600" fill="#111827">Tester export</text><text x="192" y="103" text-anchor="middle" font-size="8" fill="#6B7280">Heyreach · CRM</text><line x1="216" y1="52" x2="240" y2="52" stroke="#D1D5DB" stroke-width="1.5" marker-end="url(#ar6)"/><circle cx="264" cy="52" r="24" fill="#F9FAFB" stroke="#D1D5DB" stroke-width="1"/><text x="264" y="48" text-anchor="middle" font-size="13" font-weight="700" fill="#374151">4</text><text x="264" y="62" text-anchor="middle" font-size="8" fill="#6B7280">✓</text><text x="264" y="90" text-anchor="middle" font-size="9" font-weight="600" fill="#111827">Checklist</text><text x="264" y="103" text-anchor="middle" font-size="8" fill="#6B7280">Is Outreach Ready</text><line x1="288" y1="52" x2="312" y2="52" stroke="#D1D5DB" stroke-width="1.5" marker-end="url(#ar6)"/><circle cx="336" cy="52" r="24" fill="#E0F5EE" stroke="#0F6E56" stroke-width="1.5"/><text x="336" y="48" text-anchor="middle" font-size="13" font-weight="700" fill="#085041">5</text><text x="336" y="62" text-anchor="middle" font-size="8" fill="#0F6E56">✓</text><text x="336" y="90" text-anchor="middle" font-size="9" font-weight="600" fill="#111827">Schedule</text><text x="336" y="103" text-anchor="middle" font-size="8" fill="#0F6E56">Weekly défaut</text><rect x="50" y="120" width="440" height="62" rx="9" fill="#E0F5EE" stroke="#0F6E56" stroke-width="1.5"/><text x="270" y="138" text-anchor="middle" font-size="11" font-weight="700" fill="#085041">Is Outreach Ready = TRUE si les 6 conditions sont vraies</text><text x="160" y="156" text-anchor="middle" font-size="9" fill="#0F6E56">✓ Company Status = Approved</text><text x="160" y="170" text-anchor="middle" font-size="9" fill="#0F6E56">✓ Work Email = VALID</text><text x="160" y="184" text-anchor="middle" font-size="9" fill="#0F6E56">✓ LinkedIn URL exists</text><text x="380" y="156" text-anchor="middle" font-size="9" fill="#0F6E56">✓ Lead Status = Approved</text><text x="380" y="170" text-anchor="middle" font-size="9" fill="#0F6E56">✓ Job Title not empty</text><text x="380" y="184" text-anchor="middle" font-size="9" fill="#0F6E56">✓ Not in Blocklist</text></svg>`,
};
